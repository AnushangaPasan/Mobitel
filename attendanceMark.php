            ...
            if (!empty($_POST["f_traineeId"]) || !empty($_POST["f_NIC"])) {
                ...
                if (!empty($_POST["f_traineeId"])) {
                    ...
                    if (!preg_match("/^[0-9]+$/", $_POST["f_traineeId"])) {
                        ...
                        $search_traineeId1 = $search_traineeId;
            ...
            if (empty($search_NIC)) {
                ...
                if ($resultSet->num_rows == 1) {
                   ...
                   // $rows1 = mysqli_fetch_assoc($resultSet1);
                    ...
                    //$ID = $rows1['ID_number'];
                    $tblID = $rows['Trainee_ID'];


                    $sql1 = "SELECT * FROM `tbl_rfid` WHERE `rfid_user_ID` = '$tblID' ";
                                ...
                                <div class="panel-body">
                                    <div class="form-group">
                                        ...
                                        <div class="input-group">
                                            ...
                                            placeholder="Trainee ID" autofocus="autofocus" >
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="input-group" >
                                            ...
                                            placeholder="XXXXXXXXXV" style="width: 350px;">
...
<div class="container col-md-3 col-md-pull-1">
    ...
    if (isset($_POST['btnSubmit'])) {
        ...
        $result = $con->query(" SELECT * FROM tbl_trainee WHERE Trainee_ID like '%$search_traineeId1' OR NIC='$NIC' ");
...
<div id="myDIV">
                ...
                <tbody>
                    <tr>
                        <div class="col-sm-2">
                         ...
                         <div class="col-sm-2">
                            <?php if (empty($trainee_id_error) && empty($NIC_error) && empty($error)) { ?>
                            <td><input type="text" class="form-control" name="traineeIdinoc1"
    ...
    <form action="RegisterAction">
        <div class="container col-md-10 col-md-offset-1">
            ...
            <div class="col-md-5"><h2>Today Attendance</h2></div>
            <table class="table table-hover table-bordered ">
                ...
                <tbody>
                    ...
                    $sql = "SELECT *  FROM tbl_attendence WHERE  CurrentDate='$today 08:00:00'  ";
