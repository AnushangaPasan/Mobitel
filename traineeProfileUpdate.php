...
//            }
    ...
    } else if (!preg_match("/^[a-zA-Z.\-\/\s]{2,255}$/", $_POST["v_fname"])) {
        $Full_Name_err = "Please enter valid Name,Name not less than 3 characters.";
    } else {
...
*/	else {
    ...
    } else if (!preg_match('/^[a-zA-Z0-9\,\-\.\/\s]+$/', $_POST["v_add1"])) {
    ...
    } else if (!preg_match('/^[a-zA-Z0-9\,\.\-\/\s]+$/', $_POST["v_add2"])) {
    ...
    } else if (!preg_match('/^[a-zA-Z0-9\,\.\-\/\s]+$/', $_POST["v_add3"])) {
    ...
    if (empty($_POST["v_year"])) {
        ...
        $Year_err = "This value should be numeric.";
    ...
    } else if (!preg_match("/^\w+( \w+)*[a-zA-Z.\s]+$/", $_POST["v_con"])) {
    ...
    } else if (!preg_match("/^\w+( \w+)*[0-9a-zA-Z\,\.\s\/]+$/", $_POST["v_conAdd"])) {
    ...
    if (empty($_POST["v_branch"])) {
        $branch_err = "This value is required.";
    ...
    if (empty($_POST["v_salary"])) {
     ...
     if ($_POST["v_department"] == 0) {
        $divi_err = "Please select Division";
    } else {
        $divi = $_POST["v_department"];
...
if (isset($_GET["idDec"])) {
    ...
    $sql = "DELETE FROM tbl_trainee_temp WHERE tblTraineeID ='" . $_GET["idDec"] . "' ";
    if ($con->query($sql) === TRUE) {
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-8">
                                <input type="text" class="form-control" name="v_trainee_ID" id="v_Trainee_ID"
                                       placeholder="MOB/INOC/" value="<?php echo $ID; ?>" disabled>
                            </div>
                            <?php if (isset($_POST["btnSubmit"])) { ?>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-8">
                                <input type="date" class="form-control" name="v_dob" id="v_dob"
                                       placeholder="Date_of_Birth" value="<?php echo $DOB; ?>">
                            </div>
                            <?php if (isset($_POST["btnSubmit"])) { ?>
    ...
    <div class="panel-group">
            ...
            <div>
                <div class="panel-body">
                    ...
                    <?php } ?>
                        ...
                        <div  class="form-group">
                            <label for="inputText2" class="col-sm-4 control-label">Upload CV</label> <input type="file" name="image1" class="btn btn-info waves-effect waves-light m-b-5" multiple="multiple">
                        </div>
        ...
        <div class="container col-md-6 col-md-offset-3">
            ...
            <div class="panel-group">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-8">
                                <select class="form-control" name="v_JobType" id="v_JobType">
                                    ...
                                    <option value='--SELECT--' <?=$job_type == '' ? ' selected="selected"' : '';?> --SELECT--</option>

                                    <option value='ON JOB' <?=$job_type == 'ON JOB' ? ' selected="selected"' : '';?> ON JOB</option>
                                    <option value='GENERAL' <?=$job_type == 'GENERAL' ? ' selected="selected"' : '';?>GENERAL</option>
                                </select>
                            </div>
                        </div>
                        <div class="form-group">
                                ...
                                <select class="form-control" name="v_department" id="v_department">
                                    ...
                                    if ($department_data->num_rows >= 1) :
                                        while ($row = mysqli_fetch_assoc($department_data)) :?>
                                            <option value="<?php echo $row["tblDivisionID"] ?>" <?php if ($row["tblDivisionID"]== $tblDivisionID): ?> selected="selected";
                                                    <?php endif ?>>
                                                <?php echo $row["Name"] ?>
                                            </option>
                                            <?php
                                    ...
                                    <script type="text/javascript">
                            document.getElementById('v_department').value = "<?php echo $_POST['v_department'];?>";
                        </script>
                                </select>
                            </div>
                        </div>
                ...
                <br/>
                <input type="submit" class="btn btn-warning btn-lg btn-block" name="btnSubmit" value="Update">
            </br></br>
            </div>
    </form>
</center>
