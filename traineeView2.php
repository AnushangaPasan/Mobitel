...
$sql = "SELECT *  FROM tbl_trainee WHERE Trainee_ID='" . $_GET['idatt'] . "' ";
...
if (isset($_POST["btnSubmit"])) {
  ...
  header("Location:rptAttendance.php");
          ...
          <div class="col-sm-8">
            ...
            <select class="form-control" name="v_institute" id="v_institute" disabled>
              ...
              if ($institute_data->num_rows >= 1) :
                ...
                <option value="<?=$row["tblTrainingInstituteID"]?>" <?php if ($row["tblTrainingInstituteID"]==$tblTrainingInstituteID): ?>
                  selected="selected";
                <?php endif ?>>
                <?=$row["TrainingInstitute_Name"]?>
          ...
          <div class="col-sm-8">
           <select class="form-control" name="v_course" id="v_course" disabled>
            ...
            if ($course_data->num_rows >= 1) :
              ...
              <option value="<?=$row["tblCourseID"]?>" <?php if ($row["tblCourseID"]==$tblCourseID): ?>
                selected="selected";
              <?php endif ?>>
              <?=$row["Course_Name"]?>
            ...
            <!--  <input type="text" class="form-control" name="v_bank" id="v_bank"
              ...
              <select class="form-control" name="v_bank" id="v_bank" disabled >  
                ...
                if ($bank_data->num_rows >= 1) :
                  ...
                  <option value="<?=$row["tblBankID"]?>" <?php if ($row["tblBankID"]==$tblBankID): ?>
                    selected="selected";
                  <?php endif ?>>
                  <?=$row["Bank_Name"]?>
          ...
          <div class="col-sm-8">
           <select class="form-control" name="v_department" id="v_department" disabled>
            ...
            if ($department_data->num_rows >= 1) :
              ...
              <option value="<?= $row["tblDivisionID"] ?>" <?php if ($row["tblDivisionID"]== $tblDivisionID): ?> selected="selected";
              <?php endif ?>>
              <?=$row["Name"]?>
